...
def main():
    ...
    parser.add_argument(
        "operation", choices=["upload", "download"], help="Operation to perform"
    )
    ...
    if args.operation == "upload":
        ...
        success, content = download_file(
            args.access_key, args.secret_key, args.endpoint_url, args.bucket, args.key
        )
