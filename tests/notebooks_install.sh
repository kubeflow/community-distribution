...
kubectl -n kubeflow rollout status deployment/pvcviewer-controller-manager --timeout=180s
kubectl -n kubeflow rollout status deployment/tensorboard-controller-deployment --timeout=180s
kubectl -n kubeflow rollout status deployment/tensorboards-web-app-deployment --timeout=180s
kubectl -n kubeflow rollout status deployment/volumes-web-app-deployment --timeout=180s
