...
* If you do not want to install all components, you can comment out **Knative**, **Katib**, **Tensorboards Controller**, **Tensorboards Web Application**, **Trainer**, and **KServe** from [example/kustomization.yaml](https://github.com/kubeflow/community-distribution/blob/master/example/kustomization.yaml).
