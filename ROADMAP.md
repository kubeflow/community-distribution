# Kubeflow Community Distribution ROADMAP

For the latest information please consult https://github.com/kubeflow/community-distribution/releases and in general https://github.com/kubeflow/community-distribution .

## Kubeflow Community Distribution 1.11 Release, Planned for release: December 2025
...
- [Kubeflow Community Distribution (Manifests+Security)](https://github.com/kubeflow/manifests/releases/tag/v1.11.0)
...
- Model Registry UI
- Spark Operator as a core Kubeflow Community Distribution component
...
- [Kubeflow Community Distribution (Manifests+Security)](https://github.com/kubeflow/manifests/issues/2763)
...
## Kubeflow Community Distribution 1.7 Release, Delivered: March 2023
...
## Kubeflow Community Distribution 1.6 Release, Delivered: September 2022

- Kubeflow Community Distribution 1.6 [milestones and timelines](https://github.com/kubeflow/community/tree/master/releases/release-1.6)
...
### Major Features from each Working Group (note: Individual WG versions are independent of Kubeflow Community Distribution's)
...
## Kubeflow Community Distribution 1.5 Release, Delivered: March 2022

- Kubeflow Community Distribution 1.5 [milestones and timeline](https://github.com/kubeflow/community/pull/538)
...
## Kubeflow Community Distribution 1.4.1 Release, Delivered: December 2021
...
## Kubeflow Community Distribution 1.4 Release, Delivered: October 2021
...
- Reduce redundant code in training operators and Kubeflow Community Distribution’s web apps
...
## Kubeflow Community Distribution 1.3 Features, Released: April 2021

The Kubeflow Community Distribution 1.3 roadmap includes many User Interface (UI) improvements and core Kubeflow Community Distribution component upgrades to improve installation, management, and authentication. It also includes support for the latest Istio versions.
...
Core improvements to Kubeflow Community Distribution Installation, Management, Authentication, and Istio

- Support for latest Istio versions across Kubeflow Community Distribution applications:
  - KFP, Profile-Controller and KFAM will support the new AuthorizationPolicy API
- Manifests refactor:
  - Easy installation of Kubeflow Community Distribution applications and common services
...
Kubeflow Community Distribution 1.2 provides valuable enhancements to HyperParameter Tuning, Pipelines, KFServing, Notebooks and the Training Operators, which improve Kubeflow Community Distribution operations and data scientist productivity.
...
## Kubeflow Community Distribution 1.1 Features, Release Date: Late June 2020

Kubeflow Community Distribution 1.1 will continue to enhance enterprise grade functionality for secure operations and upgrades. 1.1 will also simplify ML workflows to improve data scientist productivity.

The following features were delivered in Kubeflow Community Distribution 1.1:
...
## Kubeflow Community Distribution 1.0

Kubeflow Community Distribution 1.0 was released on March 2, 2020. The 1.0 release consists of the following key pieces

- A core set of applications targeting the critical user journey of build-train-deploy
- Scaffolding to securely deploy and manage multi-user Kubeflow Community Distribution environments on-prem and in the cloud.
- A process to graduate Kubeflow Community Distribution components to a stable version based upon an Application Requirements definition that has been defined and validated by the Community’s testing process.

The following applications graduated to stable versions in Kubeflow Community Distribution 1.0.
...
The following applications are considered in a beta version in Kubeflow Community Distribution 1.0.
...
- We will only support a single shared Kubeflow Community Distribution deployment per Kubernetes cluster
- Users can consume Kubeflow Community Distribution in their own, isolated namespace
- Upgrades will require downtime

## Kubeflow Community Distribution 0.7

Following Kubeflow Community Distribution's quarterly release schedule Kubeflow Community Distribution 0.7 will be released in October 2019.
...
- kfctl to beta quality in 0.7
  - 1.0 in the following release
- v1beta1 for KfDef
  - Create a more consistent and clean API for describing Kubeflow Community Distribution deployments
...
- Kubernetes' [applications](https://github.com/kubernetes-sigs/application)
  provide a unified view of the deployed Kubeflow Community Distribution applications and their state
...
- Restrict Kubeflow Community Distribution access to subset of namespaces ([kubeflow/kubeflow#3623](https://github.com/orgs/kubeflow/projects/18))
...
## Kubeflow Community Distribution 0.6
...
- kfctl can now take a single YAML file specifying a KFDef describing Kubeflow Community Distribution ([example](https://github.com/kubeflow/kubeflow/blob/master/bootstrap/config/kfctl_gcp_iap.yaml))
...
# Kubeflow Community Distribution 2019 roadmap
...
Kubeflow Community Distribution does a major release at the end of every quarter. Minor releases occur as needed to fix important bugs.
